...
package. Resolve framework and scripts from the outer package root, including
when reading a bundled specialist. Resolve a specialist's references/assets from
its resource_root in package-catalog.json. Do not require a host-specific API,
